...
function App() {
    ...
    if (connected && account) {
        instantiateManifest = new Manifest()
    ...
    if (connected && componentAddr && adminBadge && memberBadge && account) {
        if (adminAccount) {
            becomeMemberManifest = new Manifest()
    ...
    const voteChoiceForm = (
        <FormControl>
            <FormLabel id='vote-choice-form'>vote</FormLabel>
            <RadioGroup
                row
